...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_StationWindow_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_StationWindow_t qt_meta_stringdata_StationWindow = {
    {
QT_MOC_LITERAL(0, 13) // "StationWindow"
...
const QMetaObject StationWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_StationWindow.offsetsAndSize,
    qt_meta_data_StationWindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_StationWindow_t
, QtPrivate::TypeAndForceComplete<StationWindow, std::true_type>
